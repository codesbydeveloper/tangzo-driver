...
class Constant {
  ...
  static Widget loader() {
    return Center(
      child: CircularProgressIndicator(color: AppThemeData.driverApp300),
    );
  }
  ...
  //   canvas.rotate(180 * 3.1415926535 / 240);
  //   canvas.translate(-w / 2, -h / 2);
          ...
          return Theme(
            data: Theme.of(context).copyWith(
              colorScheme: ColorScheme.light(
                primary: AppThemeData.driverApp300, // header background color
