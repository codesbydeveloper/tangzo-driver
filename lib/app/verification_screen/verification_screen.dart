                  ...
                  : Column(
                      ...
                      children: [
                        ...
                        TranslatedText(
                          ...
                          style: TextStyle(fontSize: 14, color: themeChange.getThem() ? AppThemeData.grey200 : AppThemeData.grey700, fontFamily: AppThemeData.regular),
                        ),
                        const SizedBox(
                          height: 40,
                        ),
                                      ...
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            TranslatedText(
                                              "${documentModel.frontSide == true ? "Front" : ""} ${documentModel.backSide == true ? "And Back".tr : ""} ${'Photo'.tr}",
                                              style: TextStyle(
