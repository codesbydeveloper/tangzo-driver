          ...
          return Scaffold(
            body: controller.isLoading.value
                ...
                : Constant.userModel?.vendorID?.isEmpty == true && Constant.userModel?.isAutoVerify == false && Constant.userModel?.isDocumentVerify == false
                    ...
                    : Column(
                        children: [
                          Constant.userModel?.vendorID?.isEmpty == true && double.parse(controller.driverModel.value.walletAmount.toString()) < double.parse(Constant.minimumDepositToRideAccept)
                              ? Padding(
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: TabBar(
                                              ...
                                              tabs: Constant.userModel?.vendorID?.isEmpty == true
                                                  ? [
                                                      Tab(
                                                        text: "New".tr,
                                                      ),
                                                ...
                                                children: [
                                                  if (Constant.userModel?.vendorID?.isEmpty == true)
                                                    controller.newOrder.isEmpty
                                                        ? Constant.showEmptyView(message: "New Order not found.".tr)
                                                        : ListView.builder(
                                                            shrinkWrap: true,
                                                                                  ...
                                                                                  children: [
                                                                                          ...
                                                                                          return Padding(
                                                                                            ...
                                                                                            child: index == 0
                                                                                                ...
                                                                                                : Column(
                                                                                                    ...
                                                                                                    children: [
                                                                                                      TranslatedText(
                                                                                                        "${'Deliver to :'.tr} ${orderModel.author?.fullName()}",
                                                                                                        textAlign: TextAlign.start,
                                                                                                        style: TextStyle(
                                                                                                          fontFamily: AppThemeData.semiBold,
                                                                                                          fontSize: 16,
                                                                                    ...
                                                                                    if (orderModel.isFreeDelivery == true)
                                                                                      Column(
                                                                                        ...
                                                                                        children: [
                                                                                          Text(
                                                                                            "${Constant.amountShow(amount: orderModel.deliveryCharge)} Delivery charge for this order will be paid by the admin.",
                                                                                            textAlign: TextAlign.start,
                                                                                            style: TextStyle(
                                                                                              fontFamily: AppThemeData.regular,
