            ...
            child: Padding(
              ...
              child: ListView(
                ...
                children: <Widget>[
                  ...
                  ListTile(
                    ...
                    trailing: Transform.scale(
                      ...
                      child: CupertinoSwitch(
                        ...
                        activeTrackColor: AppThemeData.driverApp300,
                  ...
                  Visibility(
                    visible: (Constant.userModel?.vendorID?.isEmpty == true || Constant.userModel?.vendorID == null) && Constant.userModel?.isAutoVerify == false,
                    child: ListTile(
                      visualDensity: const VisualDensity(horizontal: 0, vertical: -2),
                      contentPadding: const EdgeInsets.only(left: 0.0, right: 0.0),
                      leading: SvgPicture.asset(
                  ...
                  ListTile(
                    ...
                    onTap: () {
                      Get.back();
                      if ((Constant.userModel?.vendorID?.isEmpty == true || Constant.userModel?.vendorID == null) && Constant.userModel?.isAutoVerify == false) {
                        controller.drawerIndex.value = 5;
                      } else {
                        controller.drawerIndex.value = 4;
                      }
