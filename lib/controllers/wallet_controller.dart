...
import 'package:driver/controllers/paymongo_controller.dart';
...
import 'package:driver/payment/mtn_momo_payment_screen.dart';
...
import 'package:driver/payment/weburlservicescreen.dart';
...
//Paypal
  ...
  Future<void> stripeMakePayment({required String amount}) async {
    try {
      ShowToastDialog.showLoader("Please wait");
      await flutterStipe.Stripe.instance.resetPaymentSheetCustomer();
  ...
  Future<void> displayStripePaymentSheet({required String amount}) async {
    try {
      ...
      if (e.error.code == flutterStipe.FailureCode.Canceled) {
        ShowToastDialog.closeLoader();
